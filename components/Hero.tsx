...
const Hero = () => {
  return (
    <section className='max-container padding-container flex flex-col gap-20 py-10 pb-20 md:gap-28 lg:py:20 xl:flex-row border-2'>
        <div className='hero-map'/>
        <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
            <Image src="camp.svg" alt='camp' width={50} height={50} className='absolute left-[-5px] top-[-30px] w-10 lg:w-[50px]'/>


        <h1 className='bold-40 xl:bold-88'>
            Putuk Truno Camp Area
        </h1>
        <p className='regular-16 mt-6 text-gray-30 xl:max-w-[520px] text-xm'>
        ...
        <div className='my-11 flex flex-wrap gap-5'>
            <div className='flex items-center gap-2'>
                {Array(5).fill(1).map((_, index)=>(
                    <Image src="/star.svg" key={index} alt='star' width={24} height={20}/>
                ))}
            </div>
            <p className='bold-14 flex lg:bold-18 text-blue-70'>
                198k
            ...
            <div className='relative z-20 w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8'>
                <div className='flex flex-col'>
                    ...
                    <div className='flexBetween'>
                        ...
                        <p className='text-white'>174.28 mi</p>
                        </div>

                        <div className='flex flex-col'>
                             <p className='regualr-16 text-gray-20'>Elevation</p>
                             <p className='text-white'>2 Km</p>
                        </div>
                    </div>
